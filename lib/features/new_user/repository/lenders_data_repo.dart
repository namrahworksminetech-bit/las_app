...
Future<Result<MfDetailsResponse>> fetchLendersAndPortfolio({
  ...
  bool useMock = true, // 🔥 mock toggle added
}) async {
  try {
  ...
  return Success(MfDetailsResponse.fromJson(decoded));
    }
  ...
  // Toggle this for quick local testing
  ...
  try {
    ...
    if (useMock) {
      ...
      // Example mock response structure — adapt fields to match your MfDetailsResponse.fromJson expects
   final mockResponse = '''{
    "status": "success",
    "data": {
        "fund_details": [
  ...
  return Success(MfDetailsResponse.fromJson(decoded));
    ...
    //       'Content-Type': 'application/json',
    //     },
    //     // Allow parsing body even for non-2xx so we can show server message
