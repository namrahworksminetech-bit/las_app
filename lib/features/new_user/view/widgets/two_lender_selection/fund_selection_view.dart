...
class FundSelectionView extends StatelessWidget {
  ...
  // void _startKycAndNavigate(BuildContext context, Lender selectedLender) async {
  //   final reqId = GetIt.instance<AppStateProvider>().reqId;
  //   if (reqId == null) {
  //     ScaffoldMessenger.of(context).showSnackBar(
  //       const SnackBar(content: Text('Missing request ID. Please restart the process.')),
  //     );
  //     return;
  //   }
  //
  //   KycService.startKyc(
  //     context,
  //     lenderCode: selectedLender.name,
  //     reqId: reqId,
  //     onSuccess: () {
  //       Navigator.push(
  //         context,
  ...
  Future<void> _showEditLoanDialog(
    ...
    final portfolioData = blocContext
                      ...
                      ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          return FundListItem(
                            ...
                            onToggle: () => context.read<EligibilityBloc>().add(
